...
private:
    ...
    // Damping design
    double compute_gamma(Eigen::Matrix3d& Lambda, Eigen::Vector3d& k_t, double damping_factor);
    ...
    std::shared_ptr<qbrobotics_research_api::CommunicationLegacy> comm_handler_;
