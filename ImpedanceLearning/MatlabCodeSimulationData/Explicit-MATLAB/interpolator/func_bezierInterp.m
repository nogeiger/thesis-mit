function [ x_cur ] = func_bezierInterp( x_ini, A_vec, t_cur, t_fin, nrRounds )
% ===========================================================================
% func_bezierInterp - Simple interpolator for robot trajectories
%
% Input:
...
if t_cur <= t_fin * nrRounds
    ...
    t_bez = t_cur ./ t_fin; % Normalized time
    x_cur = x_ini + A_vec/2 .* (3 .* (1 - t_bez).^2 .* t_bez + 3 .* (1 - t_bez) .* t_bez.^2 + t_bez.^3);
